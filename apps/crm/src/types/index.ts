export type UserRole = 'SUPER_ADMIN' | 'CLIENT_ADMIN' | 'SALES_EXECUTIVE' | 'MARKETING_MANAGER'
...
export type PropertyType = 'VILLA' | 'APARTMENT' | 'PLOT' | 'BUNGALOW' | 'COMMERCIAL' | 'FARMHOUSE'
